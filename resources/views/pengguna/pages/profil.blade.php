...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" action="{{ route('pasien.profil.edit', $data->id) }}" method="post">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9 col-12 mb-3">
                                <input type="text" name="nama" value="{{ $data->nama_pasien }}" id="nama" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 col-12">
